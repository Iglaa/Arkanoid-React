You can play here:
https://iglaa.github.io/Arkanoid-React

This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
And [Yarn package manager](https://yarnpkg.com/lang/en/) To run project localy please install Yarn and type in the project directory:
